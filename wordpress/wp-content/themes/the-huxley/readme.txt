...
Huxley THEME WordPress Theme, Copyright 2015
Huxley THEME is distributed under the terms of the GNU GPL
...
=================================
This theme is bundled with Source Serif Pro Font
=================================
* This Font Software is licensed under the SIL Open Font License, Version 1.1.
* This license can also be found at this permalink: http://www.fontsquirrel.com/license/source-serif-pro

=================================
This theme is bundled with Montserrat Font
=================================
* Copyright (c) 2011-2012, Julieta Ulanovsky
* This Font Software is licensed under the SIL Open Font License, Version 1.1.
* This license can also be found at this permalink: http://www.fontsquirrel.com/license/montserrat
...
-> http://pixabay.com/en/lens-shutter-aperture-infinity-637558/
-> http://pixabay.com/en/chicago-usa-america-united-states-690364/
...
=================================
Version 1.0.5
 * fixed the bug on the search result page.
Version 1.0.4
 * fixed the bug on the archive pages.
Version 1.0.3
 * updated the text-domain
Version 1.0.2
 * updated text domain for translations
 * updated TGMPA to 2.4.2
 * updated huxley.php file
 * used pre_get_post filter and removed the custom query on index.php file
 * removed the line that removes core functionality
 * escaped the color options on output, used esc_attr_e
Version 1.0.1
