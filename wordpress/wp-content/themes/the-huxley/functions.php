...
if ( ! function_exists( 'huxley_apply_color' ) ) :
  ...
  <style>
      ...
      cite.fn,
      .info p.author{
        color: <?php esc_attr_e( get_theme_mod('huxley_color_settings') ); ?>; 
      }
      button:hover,
      ...
      .nav li ul.children li a {
        background-color: <?php esc_attr_e( get_theme_mod('huxley_color_settings') ); ?>; 
      }
  </style>
   <?php
    }
  ...
  <style>
      ...
      #logo a:hover, 
      #logo a:focus{
        color: <?php esc_attr_e( get_theme_mod('huxley_color_settings_2') ); ?>; 
      }
      .header[role="banner"]{
        border-bottom: 2px solid <?php esc_attr_e( get_theme_mod('huxley_color_settings_2') ); ?>; 
      }
      .format-link a.link,
      .article-header,
      .blue-btn,
      ...
      .nav li ul.children li a:hover{
        background: <?php esc_attr_e( get_theme_mod('huxley_color_settings_2') ); ?>; 
      }
  </style>
   <?php
    }
...
add_action( 'huxley_register', 'huxley_register_required_plugins' );
/**
...
function huxley_register_required_plugins() {
    ...
    $config = array(
        ...
        'menu'         => 'huxley-install-plugins', // Menu slug.
